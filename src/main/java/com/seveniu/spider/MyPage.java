...
import com.seveniu.util.UrlUtils;
 ...
 * 重写 getHtml 方法
 * 1. 增加对 baseurl 的处理
 * 2. UrlUtils 自己实现, img link 等 url 的 fix , 并且完善正则表达式
 */
public class MyPage extends Page {
    ...
    public Html getHtml() {
        if (html == null) {
            String baseUrl = UrlUtils.getBaseUrl(rawText);
            if (baseUrl != null) {
                if (baseUrl.equals("/"))
                    baseUrl = UrlUtils.getHost(request.getUrl());
                html = new Html(UrlUtils.fixAllRelativeHrefs(rawText, baseUrl));
            } else {
